...
$tables = Array (
    'providerData' => Array (
        ...
        'lang04' => 'varchar(2) NULL ',
        'lang05' => 'varchar(2) NULL ',
        'lang06' => 'varchar(2) NULL ',
        'lang07' => 'varchar(2) NULL ',
        'lang08' => 'varchar(2) NULL ',
        'lang09' => 'varchar(2) NULL ',
        'lang10' => 'varchar(2) NULL ',
        'hosp01' => 'varchar(29) NULL ',
        'hosp02' => 'varchar(29) NULL ',
        'hosp03' => 'varchar(29) NULL ',
        'hosp04' => 'varchar(29) NULL ',
        'accept' => 'varchar(1) NULL ',
        'specfix' => 'varchar(50) NULL ',
